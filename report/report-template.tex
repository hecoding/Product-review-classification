...
After the training had finished we wanted to get a deeper understanding of the features which are fed into the three stacked fully connected layers. Therefore we read out the weight matrix which is used to bundle the 95 features together to the desired binary output. 

\begin{figure}[h!]
\centering
\includegraphics[width=0.7\linewidth]{../weights/plot_importance.png}
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.7\linewidth]{../weights/plot_weights.png}
\captionsetup{justification=centering}
