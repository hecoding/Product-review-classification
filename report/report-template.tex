...
The most noticeable matter from the table is that we reduced the training time significantly, only by changing the recurrent unit. The performance also improved slightly.
